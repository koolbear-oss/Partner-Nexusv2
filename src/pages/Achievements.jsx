...
import { Award, Trophy, Star, Target, TrendingUp, Plus } from 'lucide-react';
  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-start">
        <div>
          <h1 className="text-3xl font-bold text-slate-900 tracking-tight">Achievements & Badges</h1>
          <p className="text-slate-600 mt-2">
            {isAdmin ? 'Manage achievement system' : `You've earned ${earnedAchievements.length} achievements`}
          </p>
        </div>
        {isAdmin && (
